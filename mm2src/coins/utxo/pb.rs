...
pub struct GetMempoolResponse {
    ...
    pub transaction_data: ::prost::alloc::vec::Vec<
        get_mempool_response::TransactionData,
    >,
}
...
pub mod get_blockchain_info_response {
    ...
    impl BitcoinNet {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                BitcoinNet::Mainnet => "MAINNET",
                BitcoinNet::Regtest => "REGTEST",
                BitcoinNet::Testnet3 => "TESTNET3",
                BitcoinNet::Simnet => "SIMNET",
            }
        }
...
pub struct GetAddressTransactionsRequest {
    ...
    pub start_block: ::core::option::Option<
        get_address_transactions_request::StartBlock,
    >,
}
...
pub struct GetRawAddressTransactionsRequest {
    ...
    pub start_block: ::core::option::Option<
        get_raw_address_transactions_request::StartBlock,
    >,
}
...
pub struct GetSlpParsedScriptResponse {
    ...
    pub token_type: i32,
    #[prost(
        oneof = "get_slp_parsed_script_response::SlpMetadata",
        tags = "5, 6, 7, 8, 9"
    )]
    pub slp_metadata: ::core::option::Option<
        get_slp_parsed_script_response::SlpMetadata,
    >,
}
...
pub mod get_slp_trusted_validation_request {
    ...
    pub struct Query {
        ...
        pub graphsearch_valid_hashes: ::prost::alloc::vec::Vec<
...
pub struct GetSlpTrustedValidationResponse {
    ...
    pub results: ::prost::alloc::vec::Vec<
        get_slp_trusted_validation_response::ValidityResult,
    >,
}
...
pub mod get_slp_trusted_validation_response {
    ...
    pub struct ValidityResult {
        ...
        pub validity_result_type: ::core::option::Option<
...
pub mod slp_transaction_info {
    ...
    impl ValidityJudgement {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ValidityJudgement::UnknownOrInvalid => "UNKNOWN_OR_INVALID",
                ValidityJudgement::Valid => "VALID",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "UNKNOWN_OR_INVALID" => Some(Self::UnknownOrInvalid),
    ...
    impl BurnFlags {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                BurnFlags::BurnedInputsOutputsTooHigh => "BURNED_INPUTS_OUTPUTS_TOO_HIGH",
                BurnFlags::BurnedInputsBadOpreturn => "BURNED_INPUTS_BAD_OPRETURN",
                BurnFlags::BurnedInputsOtherToken => "BURNED_INPUTS_OTHER_TOKEN",
                BurnFlags::BurnedOutputsMissingBchVout => {
                    "BURNED_OUTPUTS_MISSING_BCH_VOUT"
                }
                BurnFlags::BurnedInputsGreaterThanOutputs => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "BURNED_INPUTS_OUTPUTS_TOO_HIGH" => {
                    Some(Self::BurnedInputsOutputsTooHigh)
                }
                "BURNED_INPUTS_BAD_OPRETURN" => Some(Self::BurnedInputsBadOpreturn),
                "BURNED_INPUTS_OTHER_TOKEN" => Some(Self::BurnedInputsOtherToken),
                "BURNED_OUTPUTS_MISSING_BCH_VOUT" => {
                    Some(Self::BurnedOutputsMissingBchVout)
                }
                "BURNED_INPUTS_GREATER_THAN_OUTPUTS" => {
                    Some(Self::BurnedInputsGreaterThanOutputs)
                }
                _ => None,
            }
        }
...
impl SlpTokenType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            SlpTokenType::VersionNotSet => "VERSION_NOT_SET",
            SlpTokenType::V1Fungible => "V1_FUNGIBLE",
            SlpTokenType::V1Nft1Child => "V1_NFT1_CHILD",
            SlpTokenType::V1Nft1Group => "V1_NFT1_GROUP",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "VERSION_NOT_SET" => Some(Self::VersionNotSet),
            "V1_FUNGIBLE" => Some(Self::V1Fungible),
            "V1_NFT1_CHILD" => Some(Self::V1Nft1Child),
            "V1_NFT1_GROUP" => Some(Self::V1Nft1Group),
            _ => None,
        }
    }
}
...
impl SlpAction {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            SlpAction::NonSlp => "NON_SLP",
            SlpAction::NonSlpBurn => "NON_SLP_BURN",
            SlpAction::SlpParseError => "SLP_PARSE_ERROR",
            SlpAction::SlpUnsupportedVersion => "SLP_UNSUPPORTED_VERSION",
            SlpAction::SlpV1Genesis => "SLP_V1_GENESIS",
            SlpAction::SlpV1Mint => "SLP_V1_MINT",
            SlpAction::SlpV1Send => "SLP_V1_SEND",
            SlpAction::SlpV1Nft1GroupGenesis => "SLP_V1_NFT1_GROUP_GENESIS",
            SlpAction::SlpV1Nft1GroupMint => "SLP_V1_NFT1_GROUP_MINT",
            SlpAction::SlpV1Nft1GroupSend => "SLP_V1_NFT1_GROUP_SEND",
            SlpAction::SlpV1Nft1UniqueChildGenesis => "SLP_V1_NFT1_UNIQUE_CHILD_GENESIS",
            SlpAction::SlpV1Nft1UniqueChildSend => "SLP_V1_NFT1_UNIQUE_CHILD_SEND",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "NON_SLP" => Some(Self::NonSlp),
            "NON_SLP_BURN" => Some(Self::NonSlpBurn),
            "SLP_PARSE_ERROR" => Some(Self::SlpParseError),
            "SLP_UNSUPPORTED_VERSION" => Some(Self::SlpUnsupportedVersion),
            "SLP_V1_GENESIS" => Some(Self::SlpV1Genesis),
            "SLP_V1_MINT" => Some(Self::SlpV1Mint),
            "SLP_V1_SEND" => Some(Self::SlpV1Send),
            "SLP_V1_NFT1_GROUP_GENESIS" => Some(Self::SlpV1Nft1GroupGenesis),
            "SLP_V1_NFT1_GROUP_MINT" => Some(Self::SlpV1Nft1GroupMint),
            "SLP_V1_NFT1_GROUP_SEND" => Some(Self::SlpV1Nft1GroupSend),
            "SLP_V1_NFT1_UNIQUE_CHILD_GENESIS" => Some(Self::SlpV1Nft1UniqueChildGenesis),
            "SLP_V1_NFT1_UNIQUE_CHILD_SEND" => Some(Self::SlpV1Nft1UniqueChildSend),
            _ => None,
        }
    }
}
